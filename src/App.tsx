...
export const RELICS: Relic[] = [
  ...
  { id: "widow-ring", name: "Anel Viúvo de Julia Briolet", epithet: "A joia de sete funerais luxuosos", icon: "◉", art: "/artifacts/anel-viuvo-de-julia-briolet.png", prestige: 3, start: 2, tags: ["Morte", "Traição"], lore: "Julia Briolet guardou no aro o nome de cada dono desaparecido.", power: { name: "Herança de Briolet", description: "Receba 2 moedas do espólio da viúva.", type: "gainGold", once: "act", value: 2 } },
  { id: "last-goblet", name: "Cálice da Última Canção de Ximbinha", epithet: "Ainda vibra com uma melodia que ninguém terminou", icon: "♨", art: "/artifacts/calice-da-ultima-cancao-de-ximbinha.png", prestige: 2, start: 2, tags: ["Fé", "Morte"], cursed: true, curse: { name: "Ritmo dos Mortos", description: "Sua renda é reduzida em 1 moeda a cada ato.", incomePenalty: 1 }, lore: "Ximbinha tocou a última nota; o cálice continuou cantando sozinho.", power: { name: "Brinde Dissonante", description: "Pague 3 moedas e receba 3 Prestígio.", type: "convert", once: "game", value: 3 } },
