...
export const RELICS: Relic[] = [
  ...
  { id: "heretic-grimoire", name: "Grimório de Tinta de Toriyama", epithet: "Criaturas de tinta dormem entre as páginas", icon: "▤", art: "/artifacts/grimorio-de-tinta-de-toriyama.png", prestige: 3, start: 3, tags: ["Fé", "Oculto"], lore: "Toriyama desenhou um dragão na margem; na manhã seguinte faltava uma página.", power: { name: "Traço Absolutório", description: "Anule a maldição da próxima relíquia amaldiçoada.", type: "ward", once: "game" } },
  ...
  { id: "crypt-key", name: "Chave Mestra de José", epithet: "Nenhuma fechadura admite conhecê-la", icon: "⚿", art: "/artifacts/chave-mestra-de-jose.png", prestige: 1, start: 1, tags: ["Morte", "Realeza"], lore: "José catalogou todas as portas, inclusive aquelas que ainda não existem.", power: { name: "Arquivo de José", description: "Encontre entre 1 e 4 moedas.", type: "gainGold", once: "act", value: 4 } },
  { id: "oath-dagger", name: "Adaga dos Sete Acordos de Duvan", epithet: "Um fio para cada trato quebrado", icon: "⌁", art: "/artifacts/adaga-dos-sete-acordos-de-duvan.png", prestige: 3, start: 2, tags: ["Guerra", "Traição"], lore: "Duvan nunca assinou um contrato sem deixar a adaga sobre a mesa.", power: { name: "Cobrança de Duvan", description: "Roube 2 moedas de um rival.", type: "stealGold", once: "act", target: true, value: 2, chance: 1 } },
  ...
  { id: "black-ledger", name: "Livro-Caixa de Ferndinand", epithet: "Toda dívida encontra seu nome nas páginas", icon: "▥", art: "/artifacts/livro-caixa-de-ferndinand.png", prestige: 3, start: 3, tags: ["Riqueza", "Oculto"], cursed: true, curse: { name: "Juros de Ferndinand", description: "Sua renda é reduzida em 1 moeda a cada ato.", incomePenalty: 1 }, lore: "Ferndinand registrou até as moedas que os convidados ainda pretendem ganhar.", power: { name: "Auditoria de Ferndinand", description: "Cada rival paga 1 moeda a você.", type: "tax", once: "act" } },
  ...
  { id: "broken-chain-rosary", name: "Rosário Partido do Anjo Caído", epithet: "Cada conta absolve um pecado impossível", icon: "☩", art: "/artifacts/rosario-partido-do-anjo-caido.png", prestige: 3, start: 2, tags: ["Fé", "Traição"], lore: "O Anjo Caído quebrou a última corrente e guardou os elos como oração.", power: { name: "Absolvição do Anjo Caído", description: "Purifique permanentemente uma maldição do seu Museu.", type: "purify", once: "game", target: "ownRelic" } },
  ...
  { id: "dialgo-coated-bone", name: "Osso Revestido de Dialgo", epithet: "Marfim negro banhado no verniz de um sonho ruim", icon: "⌁", art: "/artifacts/osso-revestido-de-dialgo.png", prestige: 3, start: 2, tags: ["Morte", "Oculto"], cursed: true, curse: { name: "Sussurro de Dialgo", description: "As vozes do osso reduzem sua renda em 1 moeda a cada ato.", incomePenalty: 1 }, lore: "Dialgo jurava que o osso respondia. O salão descobriu tarde demais que era verdade.", power: { name: "Ritual do Segundo Pulso", description: "Recarregue um artefato utilizado neste ato.", type: "recharge", once: "game", target: "ownRelic" } },
  ...
  { id: "dimas-last-word-hammer", name: "Martelo da Última Palavra de Dimas", epithet: "Depois da batida, toda discussão parece encerrada", icon: "♜", art: "/artifacts/martelo-da-ultima-palavra-de-dimas.png", prestige: 3, start: 3, tags: ["Guerra", "Realeza"], cursed: true, curse: { name: "Silêncio de Dimas", description: "O veredito pesa sobre o dono e custa −1 Prestígio.", penalty: 1 }, lore: "Dimas não levantava a voz. Levantava o martelo.", power: { name: "Veredito de Dimas", description: "Se o rival tiver 4 ou mais moedas, roube 2; caso contrário, roube 1 Prestígio.", type: "judgment", once: "act", target: true } },
  { id: "dimas-verdict-signet", name: "Sinete do Veredito de Dimas", epithet: "Cera negra para ordens que ninguém ousa devolver", icon: "⚜", art: "/artifacts/sinete-do-veredito-de-dimas.png", prestige: 3, start: 2, tags: ["Realeza", "Fé"], lore: "O nome de Dimas no lacre valia mais que a assinatura de qualquer rei.", power: { name: "Ordem Irrecorrível", description: "O próximo lote começa 2 moedas mais caro; se um rival vencer, você recebe 2 moedas.", type: "royalDecree", once: "act" } },
  { id: "roman-divine-lyre", name: "Lira Divina de Roman, Deus da Música", epithet: "Sete cordas afinadas com as órbitas das estrelas", icon: "♫", art: "/artifacts/lira-divina-de-roman.png", prestige: 3, start: 3, tags: ["Fé", "Desejo"], lore: "Roman tocou um acorde tão perfeito que um rival esqueceu por que desejava o próximo lote.", power: { name: "Silêncio de Roman", description: "Um rival fica fora do próximo leilão.", type: "silence", once: "game", target: true } },
  { id: "galthak-allied-shield", name: "Escudo das Raças Amigas de Galthak", epithet: "Cada brasão representa um povo protegido", icon: "◫", art: "/artifacts/escudo-das-racas-amigas-de-galthak.png", prestige: 4, start: 4, tags: ["Fé", "Guerra"], lore: "Galthak jurou que nenhuma raça amiga enfrentaria a noite sozinha.", power: { name: "Juramento de Galthak", description: "Anule o próximo poder direcionado contra seu Museu.", type: "shield", once: "act" } },
  { id: "daniel-dragon-lance", name: "Lança Dracônica de Daniel Ramos", epithet: "A arma do campeão reconhecido pelos próprios dragões", icon: "⚔", art: "/artifacts/lanca-draconica-de-daniel-ramos.png", prestige: 4, start: 4, tags: ["Guerra", "Realeza"], lore: "Daniel Ramos não derrotou os dragões; conquistou o direito de lutar ao lado deles.", power: { name: "Desafio do Campeão", description: "65% de chance de roubar 2 Prestígios de um rival.", type: "stealPrestige", once: "game", target: true, value: 2, chance: .65 } },
  { id: "haika-elemental-prism", name: "Prisma Elemental de Haika Kimira", epithet: "O foco da Alrakayz dos Elementos", icon: "✧", art: "/artifacts/prisma-elemental-de-haika-kimira.png", prestige: 3, start: 3, tags: ["Oculto", "Fé"], lore: "Haika Kimira aprisionou fogo, mar, pedra e vento sem permitir que parassem de lutar.", power: { name: "Convergência de Haika", description: "Recarregue um artefato utilizado neste ato.", type: "recharge", once: "game", target: "ownRelic" } },
  { id: "giovana-madness-tiara", name: "Diadema da Loucura de Giovana", epithet: "Uma coroa que ri de quem tenta compreendê-la", icon: "☿", art: "/artifacts/diadema-da-loucura-de-giovana.png", prestige: 4, start: 2, tags: ["Oculto", "Desejo"], cursed: true, curse: { name: "Riso da Deusa", description: "Enquanto estiver no Museu, vale −2 Prestígios.", penalty: 2 }, lore: "Giovana, Deusa da Loucura, chama de lucidez tudo aquilo que o salão teme.", power: { name: "Capricho de Giovana", description: "50% de receber 5 moedas; na falha, perca 3.", type: "coinFlip", once: "act" } },
  { id: "ana-clara-crystal-reliquary", name: "Relicário de Cristal de Ana Clara", epithet: "Uma luz calma preservada no centro do salão", icon: "✣", art: "/artifacts/relicario-de-cristal-de-ana-clara.png", prestige: 3, start: 2, tags: ["Fé", "Realeza"], lore: "Ana Clara descobriu que algumas maldições se desfazem quando finalmente são vistas.", power: { name: "Clareza de Ana", description: "Purifique permanentemente uma maldição do seu Museu.", type: "purify", once: "game", target: "ownRelic" } },
];

export const LEGENDARY_RELICS: Relic[] = [
  { id: "dragon-heart", name: "Coração do Dragão de Toriyama", epithet: "Uma criatura de tinta que aprendeu a pulsar", icon: "◆", art: "/artifacts/coracao-do-dragao-de-toriyama.png", prestige: 6, start: 5, tags: ["Guerra", "Riqueza"], legendary: true, lore: "Toriyama desenhou o coração; Daniel Ramos ensinou o dragão a sobreviver.", power: { name: "Dízimo do Dragão de Toriyama", description: "Roube 2 moedas de cada rival.", type: "tax", once: "game", value: 2 } },
...
export function artifactWindowState(player: Player, status: GameStatus): { mode: "open" | "bidding" | "spent" | "waiting" | "empty"; readyCount: number; label: string; detail: string } {
  const limit = artifactLimit(player);
  const readyCount = player.inventory.filter((relic) => actionAvailable(relic) && actionTimingAvailable(relic, status)).length;
  if (player.inventory.length === 0) return { mode: "empty", readyCount: 0, label: "Museu vazio", detail: "Conquiste uma relíquia para despertar um poder." };
  if (player.artifactsUsedAct >= limit) return { mode: "spent", readyCount: 0, label: "Limite do ato", detail: `${player.artifactsUsedAct}/${limit} ativações já utilizadas.` };
  if (readyCount > 0) return { mode: "open", readyCount, label: "Janela aberta", detail: `${readyCount} artefato${readyCount === 1 ? " pode" : "s podem"} ser ativado${readyCount === 1 ? "" : "s"} agora.` };
  if (status === "bidding") return { mode: "bidding", readyCount: 0, label: "Leilão em curso", detail: "A janela reabre depois que o martelo cair." };
  return { mode: "waiting", readyCount: 0, label: "Janela fechada", detail: "Os poderes aguardam outro momento ou já foram usados." };
}
